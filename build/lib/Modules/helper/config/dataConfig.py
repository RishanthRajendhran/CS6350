...
import Modules.Datasets.bankNote
...
dataSets = {
    ...
    "bankNote": {
        "trainPath": str(list(Modules.Datasets.bankNote.__path__)[0])+ "/train.csv",
        "testPath": str(list(Modules.Datasets.bankNote.__path__)[0])+ "/test.csv",
        "attrNames": [],
        "labelNames": ["0", "1"],
        "categoricalAttrs": [],
